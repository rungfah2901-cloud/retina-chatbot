...
faq = {
    ...
    "AMD": "โรคจอตาเสื่อมในผู้สูงอายุชนิดเปียก (Wet AMD) รักษาหลักด้วยการฉีดยาต้านสารสร้างหลอดเลือด (anti-VEGF) เข้าน้ำวุ้นตา เพื่อยับยั้งการรั่วซึมของหลอดเลือดใต้จอตา ช่วยชะลอโรคและป้องกันตาบอดถาวร โดยต้องฉีดต่อเนื่องทุกเดือนในช่วงแรก และปรับความถี่ตามอาการ",
